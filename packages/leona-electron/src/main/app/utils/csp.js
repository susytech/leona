...
/* eslint-disable */
// References: https://octonion.institute/susy-js/shell
const CSP_CONFIG = {
  ...
  // Disallow fonts.
  fontSrc: "font-src 'none';", // Additionally used in Susy-JS Shell `'self' data: https:`
  ...
  imgSrc: !IS_PROD
    ...
    : // Only allow HTTPS for images. Token provider logos must be https://
      // Allow `data:` `blob:`.
      "img-src 'unsafe-inline' file: data: blob: https:;", // Additionally used in Susy-JS Shell `'self'`
  // Disallow manifests.
  ...
  styleSrc: !IS_PROD
    ? "style-src 'self' 'unsafe-inline' file: blob:;" // Additionally used in Susy-JS Shell `data: https:`
    : "style-src unsafe-inline' file: blob:;", // Additionally used in Susy-JS Shell `data: https:`
  // Allow `blob:` for camera access (worker)
  workerSrc: "worker-src blob:;" // Additionally used in Susy-JS Shell `'self' https:`
};
/* eslint-enable */
