...
import { peerCount$, syncStatus$ } from '@susy-js/light.js';

import susyStore from '../stores/susyStore';
import * as postMessage from '../utils/postMessage';

const isApiConnected$ = susyStore.isApiConnected$;
      ...
      map(
        ([
          ...
          const status = {
            ...
            nodeConnected: isApiConnected, // Connected to local Susy Sophon node
            clockSync: isClockSync, // Local clock is not synchronised
            launching: !isApiConnected, // Launching Susy Sophon only upon startup
